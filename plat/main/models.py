...
class PlatformSettings(models.Model):
    ...
    website_title = models.CharField(blank=True , max_length=100 , null=True  ,default='Teacher Name')
...
class Part(models.Model):
    ...
    custom_youtube_url = models.CharField(blank=True , max_length=100)
...
class ChapterLecture(models.Model):
    ...
    def __str__(self):
        return self.user.username + ' Added ' + self.lecture_id + ' to ' + self.chapter_id
...
class ChapterMember(models.Model):
    ...
    def __str__(self):
        return self.member_name + ' Joined ' + self.chapter_title 
...
class BuyChapter(models.Model):
    ...
    chapter_title = models.CharField(max_length=100 ,  blank=True)
    chapter_value = models.IntegerField(editable=True , default='0' , blank=True)
    ...
    class methods(models.TextChoices):
        ...
        link = 'link',
        qr_code = 'qr_code'
    method = models.CharField(max_length=25, choices=methods.choices, default=methods.wallet, blank=True)
...
class Transaction(models.Model):
    ...
    class item_types(models.TextChoices):
        lecture = 'lecture',
        chapter = 'chapter'
    item_type = models.CharField(max_length=25, choices=item_types.choices, default=item_types.lecture , blank=True , null=True)
...
class StudentQuestion(models.Model):
    ...
    lecture_title = models.CharField(max_length=500 , blank=True)
    ...
    question_image = models.ImageField(upload_to='student_question_images' , blank=True , null=True)
...
class StudentQuestionAnswer(models.Model):
    ...
    answer_image = models.ImageField(upload_to='student_question_answer_images' , blank=True , null=True)
    answer_record = models.FileField(upload_to='answers-records' , blank=True)
...
class Answer(models.Model):
    ...
    teacher_comment = models.CharField(max_length=100 , blank=True)
